<div class="footer">
	<div class="container">
		<span class="copyright">Copyright &copy; <?php echo date('Y'); ?> Berita Kita | Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>StokCoding.com</a>
        </span>
	</div>
</div>
